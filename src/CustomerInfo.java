...
public class CustomerInfo extends JFrame {
	...
	public CustomerInfo() throws SQLException {
		...
		lblId = new JLabel("ID");
		lblId.setBounds(31, 11, 46, 16);
		contentPane.add(lblId);

		JLabel l1 = new JLabel("Number");
		l1.setBounds(150, 11, 50, 16);
		contentPane.add(l1);

		lblNewLabel = new JLabel("Name");
		lblNewLabel.setBounds(270, 11, 65, 16);
		contentPane.add(lblNewLabel);

		lblGender = new JLabel("Gender");
		lblGender.setBounds(360, 11, 46, 16);
		...
		lblCountry.setBounds(480, 11, 52, 16);
		contentPane.add(lblCountry);

		lblRoom = new JLabel("Room");
		lblRoom.setBounds(600, 11, 46, 16);
		contentPane.add(lblRoom);

		lblStatus = new JLabel("Check-in Status");
		lblStatus.setBounds(680, 11, 100, 16);
		contentPane.add(lblStatus);

		lblNewLabel_1 = new JLabel("Deposit");
		lblNewLabel_1.setBounds(800, 11, 100, 16);
